...
public sealed class CompanyUserSyncOptions
{
    public const string SectionName = "CompanyUserSync";
    ...
    public string IndividualSourceObjectName { get; set; } = "[dbo].[OSUSR_p6z_Individual]";
